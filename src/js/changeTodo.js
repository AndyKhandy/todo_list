...
function showTodoInformation(todoObject)
{
    ...
    todoDueDate.value = format(new Date(todoObject.dueDate), "yyyy-MM-dd'T'HH:mm");
}
...
function getTodoInformation(todoObject){
    ...
    changeTodoObject(newName,newDescription,newPriority,newDueDate, todoObject)
}

function changeTodoObject(newName, newDescription, newPriority, newDueDate, todoObject)
{
