...
if (!localStorage.getItem("savedProjects")) {
  localStorage.setItem(
    "savedProjects",
    JSON.stringify([
      { projectName: "Today", projectId: 1, isOther: true },
      { projectName: "Week", projectId: 1, isOther: true },
      { projectName: "Month", projectId: 1, isOther: true },
      { projectName: "Inbox", projectId: 1, isOther: false },
    ])
  );
}
...
export let currentProject = JSON.parse(
  localStorage.getItem("savedCurrentProject")
) || { projectName: "Inbox", projectId: 1, isOther: false };
